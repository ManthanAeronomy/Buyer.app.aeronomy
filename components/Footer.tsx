      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-slate-400">
              The compliance-grade marketplace for sustainable aviation fuel trading. 
              Built for producers, buyers, and auditors.
            </p>
        ...
        <div className="mt-16 border-t border-slate-800 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-slate-400">
            &copy; {new Date().getFullYear()} Aeronomy. All rights reserved. 
            Built with compliance-grade security and privacy.
          </p>
        </div>
      </div>
    </footer>
